        ...
        <div className="grid gap-8 lg:grid-cols-3">
          <div className="lg:col-span-2">
            <div className="rounded-lg border border-border bg-card p-6">
              <h1 className="mb-6 text-2xl font-semibold">Booking Details</h1>
              ...
              <div className="space-y-6">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    <p>{format(new Date(booking.start_date), "MMMM d, yyyy")}</p>
                  </div>
                  <div>
                ...
                <div>
                  ...
                  {Array.isArray(booking.selected_courses) && booking.selected_courses.length > 0 ? (
                    <ul className="list-inside list-disc space-y-1">
                      {booking.selected_courses.map((course: { name: string; price: number }, idx: number) => (
                        <li key={idx}>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    <p>{booking.includes_breakfast ? "Included" : "Not included"}</p>
                  </div>
                  <div>
                    <h3 className="mb-2 font-semibold">Transportation</h3>
                    <p>{booking.includes_transport ? "Private car with driver" : "Self-drive"}</p>
                  </div>
                </div>
                ...
                {booking.additional_requests && (
                  <div>
                    ...
                    <p className="text-muted-foreground">{booking.additional_requests}</p>
                  </div>
                )}
