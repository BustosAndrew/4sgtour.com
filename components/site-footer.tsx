            ...
            <div className="flex flex-wrap gap-2">
              ...
              <div className="bg-white rounded px-2 py-1 flex items-center justify-center h-8">
                <svg className="h-5" viewBox="0 0 780 500" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M390 130.07c-35.74 27.99-58.61 71.71-58.61 120.93s22.87 92.94 58.61 120.93c35.74-27.99 58.61-71.71 58.61-120.93s-22.87-92.94-58.61-120.93z" fill="#FF5F00"/>
                </svg>
              </div>
              {/* Amex */}
              <div className="bg-white rounded px-2 py-1 flex items-center justify-center h-8">
                <svg className="h-5" viewBox="0 0 780 500" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M108.53 247.25L67.51 352.58h47.88l6.1-14.56h14.03l6.1 14.56h52.68v-11.12l4.7 11.12h27.26l4.7-11.39v11.39h109.61l13.34-13.83 12.49 13.83 56.23.12-41.26-52.47 41.26-53.01h-55.3l-12.99 13.56-12.12-13.56H235.08l-10.26 22.91-10.51-22.91h-47.67v10.74l-5.32-10.74h-40.37l-12.42 29.02zm16.95 14.21h22.26l25.25 57.38v-57.38h24.38l19.52 41.22 17.99-41.22h24.21v67.99h-14.77l-.13-53.27-21.49 53.27h-13.21l-21.62-53.27v53.27h-30.36l-6.22-14.69H118.5l-6.22 14.69h-16.62l28.82-67.99zm14.02 19.55l-10.38 24.62h20.76l-10.38-24.62zm127.75-19.55h60.47l18.36 19.9 19.02-19.9h18.5l-28.23 34.12 28.23 33.87h-19.44l-18.36-20.19-19.3 20.19h-59.25v-67.99zm15.05 13.82v12.43h33.02v13.28h-33.02v14.65h37.03l17.23-20.22-16.49-20.14h-37.77z" fill="white"/>
                  <path d="M488.54 247.25l-40.68 67.99h25.29l6.1-14.56h14.02l6.1 14.56h52.69v-11.12l4.7 11.12h27.25l4.7-11.39v11.39h109.62l13.34-13.83 12.49 13.83 56.23.12-41.27-52.47 41.27-53.01h-55.31l-12.99 13.56-12.12-13.56h-145.14l-10.27 22.91-10.5-22.91h-47.68v10.74l-5.32-10.74h-40.36l-20.86 48.8v-48.8h-17.13v67.99h17.13v-20.18l5.19-9.11 16.08 29.29h19.18l-24.01-42.77 22.75-25.22h-16.15l-22.03 27.31v-27.31zm8.97 14.21h22.27l25.24 57.38v-57.38h24.38l19.52 41.22 18-41.22h24.21v67.99h-14.77l-.13-53.27-21.5 53.27H581.5l-21.62-53.27v53.27h-30.36l-6.22-14.69h-32.58l-6.22 14.69h-16.62l28.63-67.99zm14.02 19.55l-10.38 24.62h20.76l-10.38-24.62zm127.75-19.55h60.47l18.37 19.9 19.01-19.9h18.5l-28.22 34.12 28.22 33.87h-19.43l-18.37-20.19-19.3 20.19h-59.25v-67.99zm15.05 13.82v12.43h33.02v13.28h-33.02v14.65h37.04l17.22-20.22-16.49-20.14h-37.77z" fill="white"/>
                </svg>
              </div>
              {/* ACH/Bank */}
              <div className="bg-white rounded px-2 py-1 flex items-center justify-center h-8">
                <svg className="h-5 w-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M3 21h18v-2H3v2zm0-4h18v-2H3v2zm2-6h2v4H5v-4zm4 0h2v4H9v-4zm4 0h2v4h-2v-4zm4 0h2v4h-2v-4zM2 9l10-5 10 5v2H2V9z" fill="#1A1F71"/>
                </svg>
                <span className="ml-1 text-[10px] font-bold text-[#1A1F71]">ACH</span>
              </div>
            </div>
          </div>
        </div>
