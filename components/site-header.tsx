...
export function SiteHeader({
  ...
  return (
    <header className={`sticky top-0 z-50 w-full ${className}`}>
      <div className='relative h-[87px] bg-white/30 backdrop-blur-[7.5px] shadow-[inset_0_1px_0_rgba(255,255,255,0.40),inset_1px_0_0_rgba(255,255,255,0.32),inset_0_-1px_5px_rgba(0,0,0,0.20),inset_-1px_0_5px_rgba(0,0,0,0.16)]'>
        <div className='container h-full'>
          <div className='flex h-full items-center justify-between'>
            {/* Logo */}
            <Link href='/' className='flex items-center'>
              <div className='w-[131px] h-[41px] bg-[url(/logo.png)] bg-cover bg-center' />
            </Link>
